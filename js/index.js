(() => {
  // build/src/js/import/options.js
  var options = {
    mathUtils: {
      ...
      calcWinsize: () => ({ width: globalThis.innerWidth, height: globalThis.innerHeight })
    },
    body: $("body"),
    header: $(".page-header"),
    sliders: {
  ...
  function isNode(node) {
    if (typeof globalThis !== "undefined" && typeof globalThis.HTMLElement !== "undefined") {
  ...
  // build/src/js/import/sliders.js
  if (globalThis.matchMedia("(min-width: 390px)").matches) {
    document.querySelectorAll("[data-swiper]").forEach((el) => {
      const swiper = new core_default(el, options.sliders.home);
      swiper.isEnd;
    });
  }

  // build/src/js/import/helpers.js
  ...
  globalThis.blockScroll = function() {
    let scrollPosition = [
    ...
    let html2 = $("html");
    html2.data("scroll-position", scrollPosition);
    html2.data("previous-overflow", html2.css("overflow"));
    html2.css("overflow", "hidden");
    globalThis.scrollTo(scrollPosition[0], scrollPosition[1]);
    ;
  };
  globalThis.unblockScroll = function() {
    let html2 = $("html");
    let scrollPosition = html2.data("scroll-position");
    html2.css("overflow", html2.data("previous-overflow"));
    if (scrollPosition)
      globalThis.scrollTo(scrollPosition[0], scrollPosition[1]);
  };
  function scrollHeader() {
    const scrollTop = options.header.offset().top ? true : false;
    scrollTop ? options.header.addClass("is-scroll") : options.header.removeClass("is-scroll");
  }
